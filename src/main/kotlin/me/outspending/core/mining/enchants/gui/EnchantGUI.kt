...
import me.outspending.core.mining.enchants.EnchantType
import me.outspending.core.mining.enchants.gui.GUIUtils.calculateEnchantCost
        ...
        return gui.slot(x, y) {
            item =
                item(if (playerData.gold >= totalCost) Material.LIME_DYE else Material.RED_DYE) {
                    name =
                        "<#e3af7b>${enchant.getEnchantName().toUpperCase()} Enchant".toComponent()
                    lore =
                        listOf(
                                *description,
                                "",
