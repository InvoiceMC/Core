...
class MetaStorage internal constructor(private var player: Player, private var meta: ItemMeta) {
    ...
    fun <P, C : Any> grabValueWithDefault(key: NamespacedKey, type: PersistentDataType<P, C>, defaultValue: C): C =
        data.getOrDefault(key, type, defaultValue)
